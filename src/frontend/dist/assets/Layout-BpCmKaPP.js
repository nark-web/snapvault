...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, l as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, m as lookupResultToBuffer, n as RequestStatusResponseStatus, U as UnknownError, o as RequestStatusDoneNoReplyErrorCode, p as RejectError, q as CertifiedRejectErrorCode, s as UNREACHABLE_ERROR, I as InputError, t as InvalidReadStateRequestErrorCode, v as ReadRequestType, w as Principal, x as IDL, y as MissingCanisterIdErrorCode, H as HttpAgent, z as encode, Q as QueryResponseStatus, A as UncertifiedRejectErrorCode, B as isV3ResponseBody, D as isV2ResponseBody, F as UncertifiedRejectUpdateErrorCode, G as UnexpectedErrorCode, J as decode, K as Subscribable, O as pendingThenable, V as resolveEnabled, W as shallowEqualObjects, X as resolveStaleTime, Y as noop$1, Z as environmentManager, _ as isValidTimeout, $ as timeUntilStale, a0 as timeoutManager, a1 as focusManager, a2 as fetchState, a3 as replaceData, a4 as notifyManager, a5 as hashKey, a6 as getDefaultState, r as reactExports, a7 as shouldThrowError, b as useQueryClient, a8 as useInternetIdentity, a9 as createActorWithConfig, j as jsxRuntimeExports, R as React, aa as clsx, c as cn, ab as Record, ac as Opt, ad as Variant, ae as Vec, af as Service, ag as Func, ah as Text, ai as Principal$1, aj as Nat8, ak as Nat, al as Bool, am as Null, an as Int, L as Link, ao as useRouterState } from "./index-CMPuHGe2.js";
...
const FolderId = Text;
const CreateCheckoutInput = Record({
  "cancelUrl": Text,
  "folderId": FolderId,
  "successUrl": Text
});
const CreateFolderInput = Record({
  "name": Text,
  "priceInCents": Nat
});
const Timestamp = Int;
...
const FileId = Text;
const Profile = Record({ "name": Text, "email": Text });
...
const UpdateFolderInput = Record({
  "id": FolderId,
  "name": Text,
  "priceInCents": Nat
});
const UploadFileInput = Record({
  "blob": ExternalBlob$1,
  "name": Text,
  "size": Nat,
  "mimeType": Text,
...
const DownloadToken = Text;
const AccessCodeResult = Record({
  "isPaid": Bool,
  "downloadToken": Opt(DownloadToken),
  "folder": Folder
});
const StripeSessionId = Text;
const VerifyPaymentResult = Variant({
  "pending": Null,
  "granted": Record({ "downloadToken": DownloadToken }),
  "failed": Record({ "error": Text })
});
Service({
  ...
  "createCheckoutSession": Func([CreateCheckoutInput], [Text], []),
  "createFolder": Func([CreateFolderInput], [Folder], []),
  "deleteFile": Func([FileId], [], []),
  "deleteFolder": Func([FolderId], [], []),
  "getCallerUserProfile": Func([], [Opt(Profile)], ["query"]),
  "getCallerUserRole": Func([], [UserRole], ["query"]),
  "getFolder": Func([FolderId], [Opt(Folder)], ["query"]),
  "getStripeSessionStatus": Func([Text], [StripeSessionStatus], []),
  "getUserProfile": Func([Principal$1], [Opt(Profile)], ["query"]),
  "isCallerAdmin": Func([], [Bool], ["query"]),
  "isStripeConfigured": Func([], [Bool], ["query"]),
  "listFiles": Func([FolderId], [Vec(File)], ["query"]),
  "listFolders": Func([], [Vec(Folder)], ["query"]),
  "regenerateAccessCode": Func([FolderId], [Text], []),
  ...
  "updateFolder": Func([UpdateFolderInput], [Folder], []),
  "uploadFile": Func([UploadFileInput], [File], []),
  "validateAccessCode": Func(
    [AccessCode],
    [Opt(AccessCodeResult)],
    ["query"]
  ),
  "validateDownloadToken": Func(
    [DownloadToken, FolderId],
    [Bool],
    ["query"]
  ),
  "verifyPayment": Func([StripeSessionId], [VerifyPaymentResult], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const CreateCheckoutInput2 = IDL2.Record({
    "cancelUrl": IDL2.Text,
    "folderId": FolderId2,
    "successUrl": IDL2.Text
  });
  const CreateFolderInput2 = IDL2.Record({
    "name": IDL2.Text,
    "priceInCents": IDL2.Nat
  });
  const Timestamp2 = IDL2.Int;
  const AccessCode2 = IDL2.Text;
  ...
  const Profile2 = IDL2.Record({ "name": IDL2.Text, "email": IDL2.Text });
  ...
  const UpdateFolderInput2 = IDL2.Record({
    "id": FolderId2,
    "name": IDL2.Text,
    "priceInCents": IDL2.Nat
  });
  const UploadFileInput2 = IDL2.Record({
    "blob": ExternalBlob2,
    "name": IDL2.Text,
    "size": IDL2.Nat,
    "mimeType": IDL2.Text,
  ...
  const DownloadToken2 = IDL2.Text;
  const AccessCodeResult2 = IDL2.Record({
    "isPaid": IDL2.Bool,
    "downloadToken": IDL2.Opt(DownloadToken2),
    "folder": Folder2
  });
  const StripeSessionId2 = IDL2.Text;
  const VerifyPaymentResult2 = IDL2.Variant({
    "pending": IDL2.Null,
    "granted": IDL2.Record({ "downloadToken": DownloadToken2 }),
    "failed": IDL2.Record({ "error": IDL2.Text })
  });
  return IDL2.Service({
    ...
    "createCheckoutSession": IDL2.Func([CreateCheckoutInput2], [IDL2.Text], []),
    "createFolder": IDL2.Func([CreateFolderInput2], [Folder2], []),
    "deleteFile": IDL2.Func([FileId2], [], []),
    "deleteFolder": IDL2.Func([FolderId2], [], []),
    "getCallerUserProfile": IDL2.Func([], [IDL2.Opt(Profile2)], ["query"]),
    "getCallerUserRole": IDL2.Func([], [UserRole2], ["query"]),
    "getFolder": IDL2.Func([FolderId2], [IDL2.Opt(Folder2)], ["query"]),
    "getStripeSessionStatus": IDL2.Func([IDL2.Text], [StripeSessionStatus2], []),
    "getUserProfile": IDL2.Func([IDL2.Principal], [IDL2.Opt(Profile2)], ["query"]),
    "isCallerAdmin": IDL2.Func([], [IDL2.Bool], ["query"]),
    "isStripeConfigured": IDL2.Func([], [IDL2.Bool], ["query"]),
    "listFiles": IDL2.Func([FolderId2], [IDL2.Vec(File2)], ["query"]),
    "listFolders": IDL2.Func([], [IDL2.Vec(Folder2)], ["query"]),
    "regenerateAccessCode": IDL2.Func([FolderId2], [IDL2.Text], []),
    ...
    "updateFolder": IDL2.Func([UpdateFolderInput2], [Folder2], []),
    "uploadFile": IDL2.Func([UploadFileInput2], [File2], []),
    "validateAccessCode": IDL2.Func(
      [AccessCode2],
      [IDL2.Opt(AccessCodeResult2)],
      ["query"]
    ),
    "validateDownloadToken": IDL2.Func(
      [DownloadToken2, FolderId2],
      [IDL2.Bool],
      ["query"]
    ),
    "verifyPayment": IDL2.Func([StripeSessionId2], [VerifyPaymentResult2], [])
  });
};
...
class Backend {
  ...
  async regenerateAccessCode(arg0) {
    if (this.processError) {
      try {
  ...
  async validateDownloadToken(arg0, arg1) {
    if (this.processError) {
      try {
...
function from_candid_AccessCodeResult_n26(_uploadFile, _downloadFile, value) {
...
async function from_candid_File_n19(_uploadFile, _downloadFile, value) {
...
function from_candid_VerifyPaymentResult_n29(_uploadFile, _downloadFile, value) {
...
async function to_candid_ExternalBlob_n24(_uploadFile, _downloadFile, value) {
  return await _uploadFile(value);
}
async function to_candid_UploadFileInput_n22(_uploadFile, _downloadFile, value) {
...
async function to_candid_record_n23(_uploadFile, _downloadFile, value) {
  return {
...
async function apiFolderList(actor) {
  if (!actor) return [];
  return actor.listFolders();
}
async function apiFolderGet(actor, id2) {
  if (!actor) return null;
  return actor.getFolder(id2);
}
async function apiFolderCreate(actor, input) {
  if (!actor) throw new Error("No actor");
  return actor.createFolder(input);
}
async function apiFolderUpdate(actor, input) {
  if (!actor) throw new Error("No actor");
  return actor.updateFolder(input);
}
async function apiFolderDelete(actor, id2) {
  if (!actor) throw new Error("No actor");
  return actor.deleteFolder(id2);
}
async function apiFolderRegenerateCode(actor, id2) {
  if (!actor) throw new Error("No actor");
  return actor.regenerateAccessCode(id2);
}
async function apiFileList(actor, folderId) {
  if (!actor) return [];
  return actor.listFiles(folderId);
}
async function apiFileUpload(actor, input) {
  if (!actor) throw new Error("No actor");
  return actor.uploadFile(input);
}
async function apiFileDelete(actor, fileId) {
  if (!actor) throw new Error("No actor");
  return actor.deleteFile(fileId);
}
async function apiProfileGet(actor) {
  if (!actor) return null;
  return actor.getCallerUserProfile();
}
async function apiProfileSave(actor, input) {
  if (!actor) throw new Error("No actor");
  return actor.saveCallerUserProfile(input);
}
async function apiValidateAccessCode(actor, code) {
  if (!actor) return null;
  return actor.validateAccessCode(code);
}
async function apiCreateCheckout(actor, input) {
  if (!actor) throw new Error("No actor");
  return actor.createCheckoutSession(input);
}
async function apiVerifyPayment(actor, sessionId) {
  if (!actor) throw new Error("No actor");
  return actor.verifyPayment(sessionId);
}
async function apiValidateDownloadToken(actor, token, folderId) {
...
function useProfile() {
  ...
  const saveMutation = useMutation({
    mutationFn: (input) => apiProfileSave(actor, input),
    onSuccess: () => {
...
function Sidebar({ onClose }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "flex flex-col h-full bg-sidebar border-r border-sidebar-border w-64", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-6 py-5 border-b border-sidebar-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Link,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-sm bg-accent flex items-center justify-center shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { className: "w-4 h-4 text-accent-foreground" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-lg text-sidebar-foreground tracking-tight", children: "SnapVault" })
          ]
        }
      ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex-1 overflow-y-auto px-3 py-4", children: isAuthenticated ? /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-0.5", children: NAV_LINKS.map(({ to, label, icon: Icon2 }) => {
    ...
    }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground px-3 py-2", children: "Sign in to access your dashboard" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 pb-4 space-y-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "mb-3 opacity-40" }),
      ...
      ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 text-xs text-muted-foreground", children: [
        "© ",
...
function Layout({ children, showSidebar = true }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dark min-h-screen bg-background flex", children: [
    shouldShowSidebar && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden lg:flex lg:flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar, {}) }),
    shouldShowSidebar && mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          role: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-y-0 left-0 z-50 lg:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar, { onClose: () => setMobileOpen(false) }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-w-0", children: [
      shouldShowSidebar && /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "lg:hidden flex items-center gap-3 px-4 py-3 bg-card border-b border-border sticky top-0 z-30", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { className: "w-4 h-4 text-accent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-base tracking-tight", children: "SnapVault" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 overflow-y-auto", children }),
      !shouldShowSidebar && /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border py-6 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { className: "w-4 h-4 text-accent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-medium text-foreground", children: "SnapVault" })
        ] }),
...
function DashboardHeader({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl sm:text-3xl font-semibold text-foreground", children: title }),
...
export {
  ...
  createActor as g,
  apiFileList as h,
  apiFolderRegenerateCode as i,
  apiFolderDelete as j,
  apiFolderUpdate as k,
  apiFolderCreate as l,
  motion as m,
  apiFolderList as n,
  apiFolderGet as o,
  useProfile as p,
  ...
  buttonVariants as r,
  composeRefs as s,
  apiValidateAccessCode as t,
  useAuth as u,
  apiCreateCheckout as v,
  apiValidateDownloadToken as w,
  cva as x,
  apiVerifyPayment as y
};
